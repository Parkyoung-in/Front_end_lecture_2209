...
const persons = new Array('James', 'Maria');  // Array도 객체이므로 생성자 함수를 시용해 생성가능
console.log(cars, persons);

// Array 속성  // 파란박스가 속성(length만 있다)
...
cars.push('Benz');          // cars 변수는 배열의 데이터가 있는 곳의 주소(reference)
...
console.log(numbers);  // [ 97, 82, 67, 45, 35 ]
